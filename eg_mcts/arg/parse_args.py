...
parser.add_argument('--mlp_model_dump',
                    default='/hdd1/yan/eg-mcts/one_step_model/retro_star_value_ours.ckpt')

parser.add_argument('--mlp_templates',
                    default='/hdd1/yan/eg-mcts/one_step_model/template_rules_1.dat')
parser.add_argument('--hddpath',
                    default = '/hdd1/yan/eg-mcts/')
# ================================================== #
# search algs
...
parser.add_argument('--result_folder', default='prediction')

# dataset
parser.add_argument('--dataset', default='retro190-target')
parser.add_argument('--test_mols', default='./Data/retro190-target.txt') # 'retro190.txt'
parser.add_argument('--start', '-s', default=0)
parser.add_argument('--end', '-e', default=10)

parser.add_argument('--starting_molecules', default='./Data/origin_dict.csv') # 'dataset/chembl.csv'
parser.add_argument('--reaction_data', default='/hdd1/yan/eg-mcts/uspto.reactions.json')

# NOC
parser.add_argument('--noc_data', default='/hdd1/yan/eg-mcts/dataset/reaction_graph.gml')
