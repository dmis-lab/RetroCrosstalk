#!/bin/bash
#
# Parallel MEEA Job Execution Script
# 
# This script divides a range of values into multiple splits and runs the MEEA.py
...
while [ $CURRENT_START -lt $END_VALUE ]; do
    ...
    echo "Starting job: python ./MEEA.py --start $CURRENT_START --end $CURRENT_END --ss_model $SS_MODEL --dataset $DATASET"
    python ./MEEA.py --start $CURRENT_START --end $CURRENT_END --ss_model $SS_MODEL --dataset $DATASET &
