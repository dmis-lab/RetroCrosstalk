#!/bin/bash
#
# Parallel RETRO Job Execution Script
# 
# This script divides a range of values into multiple splits and runs the RETRO.py
...
while [ $CURRENT_START -lt $END_VALUE ]; do
    ...
    echo "Starting job: python ./RETRO.py --start $CURRENT_START --end $CURRENT_END --ss_model $SS_MODEL --dataset $DATASET"
    python ./RETRO.py --start $CURRENT_START --end $CURRENT_END --ss_model $SS_MODEL --dataset $DATASET &
